...
temperatura_1 = float(input(f"Ingrese la primer tempratura: \n"))
temperatura_2 = float(input(f"Ingrese la segunda temperatura: \n"))
temperatura_3 = float(input(f"Ingrese la tercera temperatura: \n"))

if temperatura_1 > temperatura_2 and temperatura_3:
  temperatura_max = temperatura_1

if temperatura_3 > temperatura_1 and temperatura_2:
  temperatura_max = temperatura_3

if temperatura_2 > temperatura_1 and temperatura_3:
...
print(f"La temperatura mayor es:  {temperatura_max}")
print(f"La temperatura menor es:  {temperatura_min}")
